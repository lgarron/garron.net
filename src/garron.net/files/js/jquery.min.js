...
!((a, b) => {
  ...
  (o.fn = o.prototype =
    {
      ...
      map: function (a) {
        return this.pushStack(o.map(this, (b, c) => a.call(b, c, b)));
      },
      slice: function () {
    ...
    o.extend({
      ...
      noop: () => {},
      isFunction: (a) => "function" === o.type(a),
      isArray: Array.isArray,
      isWindow: (a) => null != a && a === a.window,
      isNumeric: (a) => a - parseFloat(a) >= 0,
      isPlainObject: (a) => {
      ...
      camelCase: (a) => a.replace(p, "ms-").replace(q, r),
      nodeName: (a, b) =>
      ...
      inArray: (a, b, c) => (null == b ? -1 : g.call(b, a, c)),
      merge: (a, b) => {
  ...
  var t = ((a) => {
    ...
    (c = db.support = {}),
          ...
          return e !== l && 9 === e.nodeType && e.documentElement
            ? ((l = e),
              ...
              (d.find.TAG = c.getElementsByTagName
                ? (a, b) =>
                    typeof b.getElementsByTagName !== A
              ...
              (d.find.CLASS =
                c.getElementsByClassName &&
                ((a, b) =>
                  typeof b.getElementsByClassName !== A && n
      ...
      (db.matches = (a, b) => db(a, null, null, b)),
      ...
      (db.contains = (a, b) => ((a.ownerDocument || a) !== l && k(a), r(a, b))),
      (db.attr = (a, b) => {
        (a.ownerDocument || a) !== l && k(a);
    ...
    return (
      ...
      k(),
      (c.sortDetached = gb(
        (a) => 1 & a.compareDocumentPosition(l.createElement("div")),
      )),
      gb(
        (a) => (
        ...
        hb("type|href|height|width", (a, b, c) =>
          c ? void 0 : a.getAttribute(b, "type" === b.toLowerCase() ? 1 : 2),
        ),
      (c.attributes &&
        gb(
          (a) => (
        ...
        hb("value", (a, b, c) =>
          c || "input" !== a.nodeName.toLowerCase() ? void 0 : a.defaultValue,
        ),
      gb((a) => null == a.getAttribute("disabled")) ||
        hb(J, (a, b, c) => {
          var d;
          return c
            ? void 0
  ...
  var u = o.expr.match.needsContext,
    ...
    w = /^.[^:#[.,]*$/;
  function x(a, b, c) {
    if (o.isFunction(b)) return o.grep(a, (a, d) => !!b.call(a, d, a) !== c);
    if (b.nodeType) return o.grep(a, (a) => (a === b) !== c);
    if ("string" == typeof b) {
      if (w.test(b)) return o.filter(b, a, c);
      b = o.filter(b, a);
    }
    return o.grep(a, (a) => g.call(b, a) >= 0 !== c);
  }
  (o.filter = (a, b, c) => {
    var d = b[0];
    return (
  ...
  o.each(
    {
      ...
      parents: (a) => o.dir(a, "parentNode"),
      parentsUntil: (a, b, c) => o.dir(a, "parentNode", c),
      next: (a) => D(a, "nextSibling"),
      prev: (a) => D(a, "previousSibling"),
      nextAll: (a) => o.dir(a, "nextSibling"),
      prevAll: (a) => o.dir(a, "previousSibling"),
      nextUntil: (a, b, c) => o.dir(a, "nextSibling", c),
      prevUntil: (a, b, c) => o.dir(a, "previousSibling", c),
      siblings: (a) => o.sibling((a.parentNode || {}).firstChild, a),
      children: (a) => o.sibling(a.firstChild),
      contents: (a) => a.contentDocument || o.merge([], a.childNodes),
    },
    (a, b) => {
      o.fn[a] = function (c, d) {
  ...
  (o.Callbacks = (a) => {
    ...
    var b,
      ...
      k = {
        ...
        has: (a) => (a ? o.inArray(a, h) > -1 : !(!h || !h.length)),
        empty: function () {
          return (h = []), (f = 0), this;
        },
        disable: function () {
      ...
      Deferred: (a) => {
        var b = [
          ...
          d = {
            ...
            promise: (a) => (null != a ? o.extend(a, d) : d),
          },
          e = {};
        return (
          (d.pipe = d.then),
  ...
  var J = (o.access = (a, b, c, d, e, f, g) => {
    ...
    if ("object" === o.type(c)) {
      ...
      j &&
        (g
          ? (b.call(a, d), (b = null))
          : ((j = b), (b = (a, b, c) => j.call(o(a), c)))),
      b)
    )
      for (; i > h; h++) b(a[h], c, g ? d : d.call(a[h], h, b(a[h], c)));
    return e ? a : j ? b.call(a) : i ? b(a[0], c) : f;
  });
  o.acceptData = (a) => 1 === a.nodeType || 9 === a.nodeType || !+a.nodeType;
  function K() {
  ...
  o.extend({
    hasData: (a) => M.hasData(a) || L.hasData(a),
    data: (a, b, c) => M.access(a, b, c),
    removeData: (a, b) => {
      M.remove(a, b);
    },
    _data: (a, b, c) => L.access(a, b, c),
    _removeData: (a, b) => {
      L.remove(a, b);
    },
  }),
  ...
  (o.event = {
      ...
      if (r) {
        c.handler && ((f = c), (c = f.handler), (e = f.selector)),
          ...
          (g = r.handle) ||
            (g = r.handle =
              (b) =>
                typeof o !== U && o.event.triggered !== b.type
    ...
    special: {
      ...
      click: {
        ...
        _default: (a) => o.nodeName(a.target, "a"),
      },
      beforeunload: {
        postDispatch: (a) => {
    ...
    o.each({ mouseenter: "mouseover", mouseleave: "mouseout" }, (a, b) => {
      o.event.special[a] = {
        delegateType: b,
        bindType: b,
        handle: function (a) {
    ...
    l.focusinBubbles ||
      o.each({ focus: "focusin", blur: "focusout" }, (a, b) => {
        var c = (a) => {
  ...
  var ub = /^margin/,
    ...
    wb = (a) => a.ownerDocument.defaultView.getComputedStyle(a, null);
  function xb(a, b, c) {
    var d,
      e,
      f,
  ...
  o.extend({
    ...
    o.each(["height", "width"], (a, b) => {
      o.cssHooks[b] = {
        get: (a, c, d) =>
          c
            ? 0 === a.offsetWidth && zb.test(o.css(a, "display"))
              ? o.swap(a, Cb, () => Ib(a, b, d))
              : Ib(a, b, d)
            : void 0,
        set: (a, c, d) => {
          var e = d && wb(a);
    ...
    (o.cssHooks.marginRight = yb(l.reliableMarginRight, (a, b) =>
      b
        ? o.swap(a, { display: "inline-block" }, xb, [a, "marginRight"])
        : void 0,
    )),
    o.each({ margin: "", padding: "", border: "Width" }, (a, b) => {
      (o.cssHooks[a + b] = {
        expand: (c) => {
          for (
  ...
  o.fn.extend({
    ...
    (Zb = {
      set: (a, b, c) => (
        b === !1 ? o.removeAttr(a, c) : a.setAttribute(c, c), c
      ),
    }),
    o.each(o.expr.match.bool.source.match(/\w+/g), (a, b) => {
  ...
  o.fn.extend({
    ...
    o.extend({
      ...
      propHooks: {
        tabIndex: {
          get: (a) =>
            a.hasAttribute("tabindex") || _b.test(a.nodeName) || a.href
              ? a.tabIndex
              : -1,
        },
      },
  ...
  o.fn.extend({
    ...
    o.each(["radio", "checkbox"], function () {
      (o.valHooks[this] = {
        set: (a, b) =>
          o.isArray(b) ? (a.checked = o.inArray(o(a).val(), b) >= 0) : void 0,
      }),
        l.checkOn ||
          (o.valHooks[this].get = (a) =>
  ...
  o.extend({
    ...
    ajaxSetup: (a, b) =>
      b ? tc(tc(a, o.ajaxSettings), b) : tc(o.ajaxSettings, a),
    ajaxPrefilter: rc(nc),
    ajaxTransport: rc(oc),
    ajax: (a, b) => {
      ...
      var c,
        ...
        v = {
          ...
          getAllResponseHeaders: () => (2 === t ? e : null),
    ...
    getJSON: (a, b, c) => o.get(a, b, c, "json"),
    getScript: (a, b) => o.get(a, void 0, b, "script"),
  }),
    o.each(["get", "post"], (a, b) => {
      o[b] = (a, c, d, e) => (
    ...
    (o.expr.filters.hidden = (a) => a.offsetWidth <= 0 && a.offsetHeight <= 0),
    (o.expr.filters.visible = (a) => !o.expr.filters.hidden(a));
  var wc = /%20/g,
    xc = /\[\]$/,
    yc = /\r?\n/g,
  ...
  a.ActiveXObject &&
    ...
    o.ajaxSetup({
      ...
      converters: { "text script": (a) => (o.globalEval(a), a) },
    }),
    o.ajaxPrefilter("script", (a) => {
      void 0 === a.cache && (a.cache = !1), a.crossDomain && (a.type = "GET");
    }),
    o.ajaxTransport("script", (a) => {
      if (a.crossDomain) {
        var b, c;
        return {
          send: (d, e) => {
  ...
  o.ajaxSetup({
    ...
    o.ajaxPrefilter("json jsonp", (b, c, d) => {
      var e,
        f,
        g,
        h =
      ...
      return h || "jsonp" === b.dataTypes[0]
        ? ((e = b.jsonpCallback =
          ...
          (b.converters["script json"] = () => (
            g || o.error(e + " was not called"), g[0]
          )),
          (b.dataTypes[0] = "json"),
          (f = a[e]),
          (a[e] = () => {
    ...
    return (
      ...
      this.length > 0 &&
        o
          ...
          .done((a) => {
            (f = arguments),
              this.html(d ? o("<div>").append(o.parseHTML(a)).find(d) : a);
          })
          .complete(
            c &&
              ((a, b) => {
                this.each(c, f || [a.responseText, b, a]);
              }),
          ),
      this
    );
  }),
    (o.expr.filters.animated = (a) =>
      o.grep(o.timers, (b) => a === b.elem).length);
  ...
  (o.offset = {
    ...
    o.each({ scrollLeft: "pageXOffset", scrollTop: "pageYOffset" }, (b, c) => {
      var d = "pageYOffset" === c;
      o.fn[b] = function (e) {
        return J(
          this,
    ...
    o.each(["top", "left"], (a, b) => {
      o.cssHooks[b] = yb(l.pixelPosition, (a, c) =>
        c
          ? ((c = xb(a, b)), vb.test(c) ? o(a).position()[b] + "px" : c)
          : void 0,
      );
    }),
    o.each({ Height: "height", Width: "width" }, (a, b) => {
      o.each({ padding: "inner" + a, content: b, "": "outer" + a }, (c, d) => {
        o.fn[d] = function (d, e) {
    ...
    "function" == typeof define && define.amd && define("jquery", [], () => o);
  var Lc = a.jQuery,
    Mc = a.$;
  return (
    (o.noConflict = (b) => (
